...
class LM:
    `def __init__(self, arpafile=None, start=START, end=END, unk=UNK, fromFile=None):
        ...
        self.load_ug(
            fid)  # read unigram lm and word map, TODO provide list of allowed chars and scrub those not contained
...
if __name__ == '__main__':
    ...
    lm = LM('/home/razzaz/Desktop/Data/diacritization/test/aljazeera.txt.clean.Train.buck')
    print  lm.score(" SaHa~ Alna~womu bimawotK")